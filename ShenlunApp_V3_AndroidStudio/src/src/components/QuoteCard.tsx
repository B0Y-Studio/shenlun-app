...
const styles = StyleSheet.create({
  ...
  body: { fontFamily: fonts.kai.regular, fontStyle: 'italic', fontSize: fontSizes.body, lineHeight: 22, marginTop: 6 },
  quoteMark: { fontSize: 18 },
  src: { textAlign: 'right', fontFamily: fonts.kai.regular, fontSize: fontSizes.micro, letterSpacing: 2, marginTop: 2 },
});
